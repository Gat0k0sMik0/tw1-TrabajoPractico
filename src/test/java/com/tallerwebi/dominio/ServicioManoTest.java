...
public class ServicioManoTest {
    ...
    List<Carta> esperadasFlor = new ArrayList<>();
    ...
    void preparo() {
        ...
        Carta carta1F = new Carta();
        Carta carta2F = new Carta();
        Carta carta3F = new Carta();
        Carta carta4F = new Carta();
        Carta carta5F = new Carta();
        Carta carta6F = new Carta();
        ...
        carta4F.setNumero(4);
        carta4F.setValor(0);
        carta4F.setPalo("Copa");

        carta5F.setId(4L);
        carta5F.setNumero(5);
        carta5F.setValor(1);
        carta5F.setPalo("Copa");

        carta6F.setId(5L);
        carta6F.setNumero(4);
        carta6F.setValor(0);
        carta6F.setPalo("Basto");

        esperadasFlor.add(carta1F);
        esperadasFlor.add(carta2F);
        esperadasFlor.add(carta3F);
        esperadasFlor.add(carta4F);
        esperadasFlor.add(carta5F);
        esperadasFlor.add(carta6F);
    ...
    public void queLosPuntosEnJuegoDelEnvidoSean2() {
        ...
        assertThat(m.getPuntosEnJuegoEnvido(), equalTo(2));
    }
    ...
    public void queLosPuntosEnJuegoDelEnvidoSean5() {
        ...
        assertThat(m.getPuntosEnJuegoEnvido(), equalTo(5));
        assertThat(leToca, notNullValue());
    }
    ...
    public void queLosPuntosEnJuegoDelEnvidoSean7() {
        ...
        assertThat(m.getPuntosEnJuegoEnvido(), equalTo(7));
        assertThat(leToca, notNullValue());
    }
    ...
    public void queLosPuntosEnJuegoDeLaFlorSeanLosEsperados() {
        ...
        whenAsignoTresCartasAlJugador(j1, esperadasFlor, m);
        whenAsignoTresCartasAlJugador(j2, esperadasFlor, m);
        // When
        servicioMano.preguntar(m, "8", 1);
        //then
        assertThat(t.getPuntosJ1(), equalTo(3));
    }
    ...
    public void queLosPuntosEnJuegoDeLaContraFlorSeanLosEsperados() {
        ...
        // When/then
        servicioMano.preguntar(m, "8", 1);
        servicioMano.preguntar(m, "10", 2); // ENVIDO
        servicioMano.responder(m, "10", "0",  1);
    ...
    public void queAlCantarFlorDesaparezcaElBoton() {
        ...
        whenAsignoTresCartasAlJugador(j2, esperadasFlor, m);
        // When/then
        servicioMano.preguntar(m, "8", 1); // ENVIDO
        assertThat(m.getPuntosEnJuegoFlor(), equalTo(98));
